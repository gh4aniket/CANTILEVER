...
const Task = ({ props, onDelete }) => {
    ...
    return (
        <div className="border p-3 rounded-md mb-5 bg-white">
            ...
            <p className="italic text-right text-gray-400">Created on: {new Date(props.createdAt).toDateString()}</p>
            <p className="italic text-right text-gray-400">Last Updated on: {new Date(props.updatedAt).toDateString()}</p>
