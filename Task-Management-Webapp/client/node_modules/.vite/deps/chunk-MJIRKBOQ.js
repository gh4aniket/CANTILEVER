...
function createBox(options = {}) {
  ...
  const Box2 = React28.forwardRef(function Box3(inProps, ref) {
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider(props) {
    ...
    const element = (0, import_jsx_runtime13.jsxs)(React32.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime13.jsxs)(React32.Fragment, {
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses15 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React34.forwardRef(function Grid3(inProps, ref) {
    ...
    const classes = useUtilityClasses15(ownerState, theme);
...
function useAutocomplete(props) {
  ...
  const prevValue = React36.useRef();
  React36.useEffect(() => {
...
function TrapFocus(props) {
  ...
  const ignoreNextEnforceFocus = React39.useRef();
...
var ModalUnstyled = React40.forwardRef(function ModalUnstyled2(props, ref) {
  const {
    BackdropComponent,
    BackdropProps,
    children,
  ...
  return (0, import_jsx_runtime20.jsx)(Portal_default, {
    ...
    container,
    disablePortal,
    children: (0, import_jsx_runtime21.jsxs)(Root, _extends({
      role: "presentation"
    }, rootProps, !isHostComponent_default2(Root) && {
      as: component,
      ...
      children: [!hideBackdrop && BackdropComponent ? (0, import_jsx_runtime20.jsx)(BackdropComponent, _extends({
        "aria-hidden": true,
        open,
        onClick: handleBackdropClick
      }, BackdropProps)) : null, (0, import_jsx_runtime20.jsx)(TrapFocus_default, {
        disableEnforceFocus,
        disableAutoFocus,
        disableRestoreFocus,
...
function appendOwnerState(elementType, existingProps = {}, ownerState) {
  if (isHostComponent_default2(elementType)) {
...
var _excluded14 = ["badgeContent", "component", "children", "className", "components", "componentsProps", "invisible", "max", "showZero"];
...
var BadgeUnstyled = React43.forwardRef(function BadgeUnstyled2(props, ref) {
  const {
    component,
    children,
    className,
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, _extends({}, rootProps, {
    ...
    className: clsx_m_default(classes.root, rootProps.className, className),
    children: [children, (0, import_jsx_runtime25.jsx)(Badge, _extends({}, badgeProps, {
...
true ? BadgeUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types27.default.shape({
    badge: import_prop_types27.default.object,
...
function useButton(parameters) {
  ...
  const [active, setActive] = React44.useState(false);
  const {
    isFocusVisibleRef,
    onFocus: handleFocusVisible,
    onBlur: handleBlurVisible,
  ...
  const [hostElementName, setHostElementName] = React44.useState("");
...
var _excluded15 = ["action", "children", "className", "component", "components", "componentsProps", "disabled", "focusableWhenDisabled", "onBlur", "onClick", "onFocus", "onFocusVisible", "onKeyDown", "onKeyUp", "onMouseLeave"];
...
var ButtonUnstyled = React45.forwardRef(function ButtonUnstyled2(props, forwardedRef) {
  ...
  const buttonRef = React45.useRef();
  ...
  return (0, import_jsx_runtime27.jsx)(ButtonRoot, _extends({}, buttonRootProps, {
    children
  }));
});
...
var FormControlUnstyledContext = React46.createContext(void 0);
if (true) {
...
var _excluded16 = ["defaultValue", "children", "className", "component", "components", "componentsProps", "disabled", "error", "onChange", "required", "value"];
function hasValue(value) {
  return value != null && !(Array.isArray(value) && value.length === 0) && value !== "";
}
var FormControlUnstyled = React47.forwardRef(function FormControlUnstyled2(props, ref) {
  var _ref;
  const {
    defaultValue,
    children,
  ...
  return (0, import_jsx_runtime28.jsx)(FormControlUnstyledContext_default.Provider, {
    value: childContext,
    children: (0, import_jsx_runtime28.jsx)(Root, _extends({
      ref
    }, rootProps, {
...
function useFormControlUnstyledContext() {
  return React48.useContext(FormControlUnstyledContext_default);
}
...
var InputUnstyled = React50.forwardRef(function InputUnstyled2(props, forwardedRef) {
  ...
  if (multiline) {
    ...
    const hasHostTextarea = isHostComponent_default2((_components$Textarea = components.Textarea) != null ? _components$Textarea : "textarea");
...
function useReducerReturnValueHandler(state, value, options, optionComparer, setValueState, onValueChange, onHighlightChange) {
  ...
  const onValueChangeRef = React51.useRef(onValueChange);
  React51.useEffect(() => {
    onValueChangeRef.current = onValueChange;
  }, [onValueChange]);
  const onHighlightChangeRef = React51.useRef(onHighlightChange);
  React51.useEffect(() => {
...
function useControllableReducer(internalReducer, externalReducer, props) {
  ...
  const propsRef = React51.useRef(props);
  ...
  const previousValueRef = React51.useRef(null);
  const [state, dispatch] = React51.useReducer(externalReducer != null ? externalReducer : internalReducer, {
    highlightedValue: null,
    selectedValue: value
  });
  const optionComparerRef = React51.useRef(optionComparer);
...
function useMenu(parameters) {
  ...
  const [menuItems, setMenuItems] = React54.useState({});
  const listboxRef = React54.useRef(null);
  const handleRef = useForkRef(listboxRef, listboxRefProp);
  const registerItem = React54.useCallback((id, metadata) => {
  ...
  const unregisterItem = React54.useCallback((id) => {
    setMenuItems((previousState) => {
      const newState = _extends({}, previousState);
      delete newState[id];
      return newState;
  ...
  const highlightFirstItem = React54.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
      setListboxHighlight(menuItems[Object.keys(menuItems)[0]].id);
    }
  }, [menuItems, setListboxHighlight]);
  const highlightLastItem = React54.useCallback(() => {
    if (Object.keys(menuItems).length > 0) {
...
var PopperTooltip = React55.forwardRef(function PopperTooltip2(props, ref) {
  const {
    anchorEl,
    children,
    direction,
...
var PopperUnstyled = React55.forwardRef(function PopperUnstyled2(props, ref) {
  const {
    anchorEl,
    children,
...
var _excluded19 = ["actions", "anchorEl", "children", "className", "component", "components", "componentsProps", "keepMounted", "onClose", "open"];
...
var MenuUnstyled = React56.forwardRef(function MenuUnstyled2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime32.jsx)(Popper, _extends({}, popperProps, {
    ref: forwardedRef,
...
true ? MenuUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types32.default.shape({
    listbox: import_prop_types32.default.object,
...
function useMenuItem(props) {
  ...
  const id = useId();
  const menuContext = React57.useContext(MenuUnstyledContext_default);
  ...
  const [focusRequested, requestFocus] = React57.useState(false);
  const focusIfRequested = React57.useCallback(() => {
...
var _excluded20 = ["children", "className", "disabled", "component", "components", "componentsProps", "label"];
...
var MenuItemUnstyled = React58.forwardRef(function MenuItemUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    children,
    className,
...
function useSelect(props) {
  ...
  const ignoreEnterKeyUp = React60.useRef(false);
  const ignoreClick = React60.useRef(false);
  const [listboxFocusRequested, requestListboxFocus] = React60.useState(false);
  const focusListboxIfRequested = React60.useCallback(() => {
  ...
  const selectedOption = React60.useMemo(() => {
...
var SelectUnstyledContext = React61.createContext(void 0);
...
var _excluded21 = ["autoFocus", "children", "className", "component", "components", "componentsProps", "defaultListboxOpen", "defaultValue", "disabled", "listboxOpen", "onChange", "onListboxOpenChange", "value"];
function defaultRenderMultipleValues(selectedOptions) {
  return (0, import_jsx_runtime34.jsx)(React62.Fragment, {
...
var MultiSelectUnstyled = React62.forwardRef(function MultiSelectUnstyled2(props, ref) {
  ...
  const [groupedOptions, setGroupedOptions] = React62.useState([]);
  const options = React62.useMemo(() => flattenOptionGroups(groupedOptions), [groupedOptions]);
  ...
  const selectedOptions = React62.useMemo(() => {
    if (value == null) {
      return [];
    }
  ...
  return (0, import_jsx_runtime35.jsxs)(React62.Fragment, {
...
true ? MultiSelectUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types34.default.shape({
    listbox: import_prop_types34.default.object,
...
var _excluded25 = ["className", "component", "components", "disabled", "componentsProps"];
...
true ? OptionGroupUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types35.default.shape({
    ...
    list: import_prop_types35.default.object,
...
var _excluded26 = ["children", "className", "component", "components", "componentsProps", "disabled", "value", "label"];
...
var _excluded27 = ["autoFocus", "children", "className", "component", "components", "componentsProps", "defaultValue", "defaultListboxOpen", "disabled", "listboxOpen", "onChange", "onListboxOpenChange", "renderValue", "value"];
...
var SelectUnstyled = React65.forwardRef(function SelectUnstyled2(props, ref) {
  ...
  const [groupedOptions, setGroupedOptions] = React65.useState([]);
  const options = React65.useMemo(() => flattenOptionGroups(groupedOptions), [groupedOptions]);
  const [listboxOpen, setListboxOpen] = useControlled({
    controlled: listboxOpenProp,
    default: defaultListboxOpen,
    name: "SelectUnstyled",
  ...
  const selectedOptions = React65.useMemo(() => {
...
true ? SelectUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types37.default.shape({
    listbox: import_prop_types37.default.object,
...
function SliderValueLabelUnstyled(props) {
  ...
  }, (0, import_jsx_runtime42.jsxs)(React66.Fragment, {
...
true ? SliderValueLabelUnstyled.propTypes = {
  ...
  theme: import_prop_types38.default.any,
...
function useSlider(props) {
  ...
  const [focusVisible, setFocusVisible] = React67.useState(-1);
...
var _excluded28 = ["aria-label", "aria-valuetext", "className", "component", "classes", "disableSwap", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "scale", "step", "tabIndex", "track", "value", "valueLabelDisplay", "valueLabelFormat", "isRtl", "components", "componentsProps"];
var Identity2 = (x) => x;
...
var SliderUnstyled = React68.forwardRef(function SliderUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime44.jsxs)(Root, _extends({}, rootProps, getRootProps({
    onMouseDown
  }), {
    className: clsx_m_default(classes.root, rootProps.className, className),
    children: [(0, import_jsx_runtime43.jsx)(Rail, _extends({}, railProps, {
      className: clsx_m_default(classes.rail, railProps.className)
    })), (0, import_jsx_runtime43.jsx)(Track, _extends({}, trackProps, {
      ...
      return (0, import_jsx_runtime43.jsx)(React68.Fragment, {
        children: (0, import_jsx_runtime43.jsx)(ValueLabelComponent, _extends({}, !isHostComponent_default2(ValueLabelComponent) && {
          valueLabelFormat,
          valueLabelDisplay,
          ...
          children: (0, import_jsx_runtime43.jsx)(Thumb, _extends({
            "data-index": index
          ...
          }, !isHostComponent_default2(Thumb) && {
            ownerState: _extends({}, ownerState, thumbProps.ownerState)
          }, {
            style: _extends({}, style4, {
              pointerEvents: disableSwap && active !== index ? "none" : void 0
            }, thumbProps.style),
            children: (0, import_jsx_runtime43.jsx)(Input, _extends({}, hiddenInputProps, {
              "data-index": index,
              "aria-label": getAriaLabel ? getAriaLabel(index) : ariaLabel,
              "aria-valuenow": scale(value),
              "aria-valuetext": getAriaValueText ? getAriaValueText(scale(value), index) : ariaValuetext,
              value: values2[index]
            }, !isHostComponent_default2(Input) && {
...
true ? SliderUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types39.default.shape({
    ...
    mark: import_prop_types39.default.object,
    markLabel: import_prop_types39.default.object,
    rail: import_prop_types39.default.object,
    root: import_prop_types39.default.object,
    thumb: import_prop_types39.default.object,
    track: import_prop_types39.default.object,
    valueLabel: import_prop_types39.default.shape({
      className: import_prop_types39.default.string,
      components: import_prop_types39.default.shape({
        Root: import_prop_types39.default.elementType
      }),
...
var _excluded29 = ["checked", "className", "component", "components", "componentsProps", "defaultChecked", "disabled", "onBlur", "onChange", "onFocus", "onFocusVisible", "readOnly", "required"];
var SwitchUnstyled = React70.forwardRef(function SwitchUnstyled2(props, ref) {
  ...
  return (0, import_jsx_runtime46.jsxs)(Root, _extends({
    ref
  }, rootProps, {
...
true ? SwitchUnstyled.propTypes = {
  ...
  componentsProps: import_prop_types40.default.shape({
    ...
    thumb: import_prop_types40.default.object,
    track: import_prop_types40.default.object
  }),
  /**
...
var useTabs = (props) => {
  ...
  const onSelected = React71.useCallback((e, newValue) => {
    setValue(newValue);
    if (onChange) {
      onChange(e, newValue);
    }
...
var Context = React72.createContext(null);
if (true) {
  Context.displayName = "TabsContext";
}
function useTabContext() {
  return React72.useContext(Context);
}
...
var _excluded30 = ["children", "className", "value", "defaultValue", "orientation", "direction", "component", "components", "componentsProps", "onChange", "selectionFollowsFocus"];
...
var TabsUnstyled = React73.forwardRef((props, ref) => {
  var _ref, _componentsProps$root;
  const {
    children,
    className,
  ...
  return (0, import_jsx_runtime47.jsx)(TabsRoot, _extends({}, getRootProps(), tabsRootProps, {
    ref,
...
var _excluded31 = ["children", "className", "value", "components", "componentsProps", "component"];
...
var TabPanelUnstyled = React74.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    children,
    className,
  ...
  return (0, import_jsx_runtime48.jsx)(TabPanelRoot, _extends({}, getRootProps(), {
    ref,
    role: "tabpanel"
  }, tabPanelRootProps, {
    className: clsx_m_default(classes.root, (_componentsProps$root = componentsProps.root) == null ? void 0 : _componentsProps$root.className, className),
...
var useTabsList = (props) => {
  ...
  const tabsListRef = React75.createRef();
  ...
  const processChildren = React75.useCallback(() => {
    const valueToIndex = /* @__PURE__ */ new Map();
    let childIndex = 0;
    const processedChildren = React75.Children.map(children, (child) => {
...
var _excluded33 = ["className", "children", "component", "components", "componentsProps"];
...
var TabsListUnstyled = React76.forwardRef((props, ref) => {
  var _ref, _componentsProps$root;
  const {
    className,
    component,
  ...
  return (0, import_jsx_runtime49.jsx)(TabsListRoot, _extends({}, getRootProps(), tabsListRootProps, {
    className: clsx_m_default(className, (_componentsProps$root = componentsProps.root) == null ? void 0 : _componentsProps$root.className, classes.root),
...
var _excluded35 = ["action", "children", "value", "className", "disabled", "onChange", "onClick", "onFocus", "component", "components", "componentsProps"];
...
var TabUnstyled = React77.forwardRef(function TabUnstyled2(props, ref) {
  var _ref, _componentsProps$root;
  const {
    action,
    children,
  ...
  return (0, import_jsx_runtime50.jsx)(TabRoot, _extends({}, getRootProps(), tabRootProps, {
    className: clsx_m_default(classes.root, (_componentsProps$root = componentsProps.root) == null ? void 0 : _componentsProps$root.className, className),
    ref,
    children
  }));
...
var SvgIcon = React78.forwardRef(function SvgIcon2(inProps, ref) {
  ...
  return (0, import_jsx_runtime52.jsxs)(SvgIconRoot, _extends({
    as: component,
    className: clsx_m_default2(classes.root, className),
    ownerState,
    focusable: "false",
    color: htmlColor,
    ...
    children: [children, titleAccess ? (0, import_jsx_runtime51.jsx)("title", {
...
function createSvgIcon(path, displayName) {
  const Component = (props, ref) => (0, import_jsx_runtime53.jsx)(SvgIcon_default, _extends({
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MJIRKBOQ.js.map
